        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="flex flex-row">
            <canvas
              ...
              className="border-t-2 border-l-2 z-10 border-b-2 border-gray-900 rounded-l-lg"
            />
            <div className="z-10 border-t-2 border-r-2  border-b-2 border-gray-900 bg-gradient-to-r from-gray-400 to-gray-900 rounded-r-lg text-white w-20 flex-shrink-0 flex flex-col items-center justify-center p-4">
              <button
              ...
              <button
                className="mb-5 rounded-full ring-2 ring-gray-200 bg-red-400"
                style={{ width: "30px", height: "30px" }}
                onClick={() => setSelectedColor("#f87171")}
              ></button>
              <button
                className="mb-5 rounded-full ring-2 ring-gray-200 bg-green-400"
                style={{ width: "30px", height: "30px" }}
                onClick={() => setSelectedColor("#4ade80")}
              ></button>
              <button
                className="mb-5 rounded-full ring-2 ring-gray-200 bg-blue-400"
                style={{ width: "30px", height: "30px" }}
                onClick={() => setSelectedColor("#60a5fa")}
              ></button>
              <button
                className="mb-5 rounded-full ring-2 ring-gray-200 bg-yellow-400"
                style={{ width: "30px", height: "30px" }}
                onClick={() => setSelectedColor("#facc15")}
              ></button>
              <button
                className="mb-5 rounded-full ring-2 ring-gray-200 bg-black"
                style={{ width: "30px", height: "30px" }}
                onClick={() => setSelectedColor("#000")}
              ></button>
              <button
                className="mb-5 rounded-full ring-2 ring-gray-200 bg-pink-400"
                style={{ width: "30px", height: "30px" }}
                onClick={() => setSelectedColor("#f472b6")}
              ></button>
              <button
                className="mb-5 rounded-full ring-2 ring-gray-200 bg-purple-400"
                style={{ width: "30px", height: "30px" }}
                onClick={() => setSelectedColor("#c084fc")}
              ></button>
              <button
                className="px-2 py-1 font-semibold text-xs a-center ring-2 hover:ring-4 ease-in-out duration-300 ring-teal-400 rounded-lg bg-slate-800 text-slate-200 tracking-widest uppercase"
